...
class PacketMotionData(Packet):
    _fields_ = [
        ...
        ("car_motion_data", CarMotionData * 2),  # Data for all cars on track
...
class PacketLapData(Packet):
    _fields_ = [
        ("header", PacketHeader),  # Header
        ("lap_data", LapData * 3),  # Lap data for all cars on track
...
class PacketParticipantsData(Packet):
    _fields_ = [
        ...
        # cars on HUD
        ("participants", ParticipantData * 2),
    ]
...
class PacketCarTelemetryData(Packet):
    _fields_ = [
        ("header", PacketHeader),  # Header
        ("car_telemetry_data", CarTelemetryData * 3),
...
class PacketCarStatusData(Packet):
    _fields_ = [
        ("header", PacketHeader),  # Header
        ("car_status_data", CarStatusData * 7),
    ]
...
class PacketFinalClassificationData(Packet):
    _fields_ = [
        ...
        ("classification_data", FinalClassificationData * 5),
    ]
...
class PacketCarDamageData(Packet):
    _fields_ = [
        ("header", PacketHeader),  # Header
        ("car_damage_data", CarDamageData * 3),
    ]
...
class PacketSessionHistoryData(Packet):
    _fields_ = [
        ...
        ("lap_history_data", LapHistoryData * 20),  # 100 laps of data max
